...
#include <cdk/ast/visitor_decls.h>
  ...
  virtual void do_apply_node(fir::apply_node *const node, int lvl) = 0;
  ...
  virtual void do_program_node(fir::program_node *const node, int lvl) = 0;
  ...
  virtual void do_writeln_node(fir::writeln_node *const node, int lvl) = 0;

#else
  void do_address_of_node(fir::address_of_node *const node, int lvl);
  void do_apply_node(fir::apply_node *const node, int lvl);
  ...
  void do_program_node(fir::program_node *const node, int lvl);
  ...
  void do_writeln_node(fir::writeln_node *const node, int lvl);
