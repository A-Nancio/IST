...
void fir::frame_size_calculator::do_leave_node(fir::leave_node*, int){
  // EMPTY
}

void fir::frame_size_calculator::do_program_node(fir::program_node*, int){
  // EMPTY
}

void fir::frame_size_calculator::do_read_node(fir::read_node*, int){
  // EMPTY
}

void fir::frame_size_calculator::do_restart_node(fir::restart_node*, int){
  // EMPTY
}

void fir::frame_size_calculator::do_writeln_node(fir::writeln_node*, int){
  // EMPTY
}